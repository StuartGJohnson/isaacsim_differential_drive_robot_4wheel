...
def add_tf_lidar(graph_path = "/ActionGraph/TFLidarPublishGraph"):
    og.Controller.edit(
        graph_path,
        {
            ...
            og.Controller.Keys.CONNECT: [
                ...
                ("sim_step.outputs:step", "readLidar.inputs:execIn"),
                ...
                ("sim_step.outputs:step", "PublishClock.inputs:execIn"),
                ("isaac_read_simulation_time.outputs:simulationTime", "PublishClock.inputs:timeStamp"),
            ]
        }
    )